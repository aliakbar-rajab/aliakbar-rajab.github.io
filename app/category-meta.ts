...
export const productGroups: ProductGroup[] = [
  {
    ...
    seoDescription:
      "قیمت روز میلگرد آجدار، ساده، استیل و آلیاژی از کارخانه‌های معتبر. استعلام قیمت لحظه‌ای و خرید میلگرد با مشاوره تلفنی.",
  },
  {
    id: "beam",
    label: "تیرآهن",
    ...
    seoDescription:
      "قیمت روز تیرآهن IPE و هاش از کارخانه‌های معتبر. استعلام قیمت لحظه‌ای و خرید تیرآهن با مشاوره تلفنی.",
  },
  {
    id: "sheet",
    label: "ورق فولادی",
    ...
    seoDescription:
      "قیمت روز ورق فولادی سیاه، گالوانیزه، روغنی و رنگی. استعلام قیمت لحظه‌ای و خرید ورق با مشاوره تلفنی.",
  },
  {
    id: "profile",
    label: "قوطی و پروفیل",
    ...
    seoDescription:
      "قیمت روز قوطی و پروفیل ساختمانی و صنعتی در ابعاد گوناگون. استعلام قیمت لحظه‌ای و خرید پروفیل با مشاوره تلفنی.",
  },
  {
    id: "pipe",
    label: "لوله فولادی",
    ...
    seoDescription:
      "قیمت روز لوله فولادی صنعتی، گازی و داربستی. استعلام قیمت لحظه‌ای و خرید لوله با مشاوره تلفنی.",
  },
  {
    id: "angle",
    label: "نبشی",
    ...
    seoDescription:
      "قیمت روز نبشی بال مساوی و بال نامساوی. استعلام قیمت لحظه‌ای و خرید نبشی با مشاوره تلفنی.",
  },
  {
    id: "channel",
    label: "ناودانی",
    ...
    seoDescription:
      "قیمت روز ناودانی سبک و سنگین برای مصارف سازه‌ای. استعلام قیمت لحظه‌ای و خرید ناودانی با مشاوره تلفنی.",
  },
  {
    id: "wire",
    label: "مفتول و سیم",
    ...
    seoDescription:
      "قیمت روز مفتول سیاه، گالوانیزه و محصولات سیمی. استعلام قیمت لحظه‌ای و خرید مفتول با مشاوره تلفنی.",
  },
];
